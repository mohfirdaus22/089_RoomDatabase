...
fun DetailScreen(
    ...
    Scaffold(
        ...
        ItemDetailsBody(
            ...
            onDelete = {
                // Note If the user rotates the screen very faast, the operation may get cancelled
                // and the item may not be delete from the Database. This is because when config
